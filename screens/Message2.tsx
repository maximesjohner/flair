    ...
    <View style={styles.message5}>
      <View style={styles.component4}>
        <View style={styles.messagecontainer}>
          <Text style={styles.messagetext}>ouais on va où ?</Text>
      ...
      <View style={styles.message5Child} />
      <Text style={styles.tom}>Tom</Text>
      <Image
        style={[styles.message5Item, styles.wrapperLayout]}
        contentFit="cover"
      ...
      <View style={styles.component3}>
        ...
        <View style={styles.messagecontainer1}>
          <Text style={styles.messagetext}>wsh ça sort ????</Text>
          <Text style={styles.timestamp}>11.14</Text>
        </View>
